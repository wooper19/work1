...
// 導入所有需要顯示的圖片
import Painting1 from "@/image/1.jpg";
import Painting2 from "@/image/2.jpg";
import Painting3 from "@/image/3.jpg";
import Painting4 from "@/image/4.jpg";
import Painting5 from "@/image/15.png";
import Painting6 from "@/image/16.png";
import Painting7 from "@/image/17.png";
import Painting8 from "@/image/18.png";
  ...
  return (
    ...
    <div className="w-full  h- 100 sm:h-full bg-white flex flex-col justify-start items-center sm:overflow-y-auto  py-12 px-6 ">
      ...
      <div className="flex flex-col w-full">
        <h1 className="text-2xl font-bold text-[#1c4f53]">商品設計</h1>
        <h3 className="text-[#1c4f53]">雨山祭 : 打火機設計 & pick設計</h3>
      </div>
      ...
      <div className="flex flex-col w-full gap-4 mt-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 w-full gap-4 h-[33vh]">
          ...
          <div
            ...
            onClick={() => openLightbox(Painting1)} // 點擊打開 Lightbox
          >
            <Image
              src={Painting1}
              alt="Painting 1"
          ...
          >
            <Image src={Painting2} alt="Painting 2" fill className="object-cover transition-opacity duration-300 group-hover:opacity-80" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 33vw, 25vw"/>
          </div>
        </div>
        {/* Row 2 */}
        <div className="grid grid-cols-2 w-full gap-4 h-[33vh]">
          ...
          >
             <Image src={Painting3} alt="Painting 3" fill className="object-cover transition-transform duration-300 group-hover:opacity-80" sizes="(max-width: 1024px) 50vw, 33vw"/>
          </div>
          {/* Image 4 */}
          <div
            className="rounded-xs relative transition-opacity cursor-pointer group bg-gray-200"
         ...
         >
            <Image src={Painting4} alt="Painting 4" fill className="object-cover transition-transform duration-300 group-hover:opacity-80" sizes="(max-width: 1024px) 50vw, 33vw"/>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col w-full mt-12">
        <h3 className="text-[#1c4f53]">藝術季 : 紋身貼紙</h3>
      </div>
      {/* --- 圖片格線 2 --- */}
      <div className="flex flex-col w-full gap-4 mt-3">
        {/* Row 1 */}
        <div className="grid grid-cols-1 sm:grid-cols-3 w-full gap-4 h-[33vh]">
           ...
           <div
            ...
            onClick={() => openLightbox(Painting6)}
          >
             <Image src={Painting6} alt="Painting 6" fill className="object-cover transition-opacity duration-300 group-hover:opacity-80" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 66vw, 50vw"/>
          </div>
           {/* Image 5 */}
           <div
            className="rounded-xs relative overflow-hidden cursor-pointer group bg-gray-200"
          ...
          >
             <Image src={Painting5} alt="Painting 5" fill className="object-cover transition-opacity duration-300 group-hover:opacity-80" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 33vw, 25vw"/>
          </div>
        </div>
         {/* Row 2 */}
        <div className="grid grid-cols-2 w-full gap-4 h-[33vh]">
         ...
         >
             <Image src={Painting7} alt="Painting 7" fill className="object-cover transition-opacity duration-300 group-hover:opacity-80" sizes="(max-width: 1024px) 50vw, 33vw"/>
          </div>
           {/* Image 8 */}
           <div
            className="rounded-xs relative overflow-hidden cursor-pointer group bg-gray-200"
         ...
         >
             <Image src={Painting8} alt="Painting 8" fill className="object-cover transition-opacity duration-300 group-hover:opacity-80" sizes="(max-width: 1024px) 50vw, 33vw"/>
          </div>
        </div>
      </div>
